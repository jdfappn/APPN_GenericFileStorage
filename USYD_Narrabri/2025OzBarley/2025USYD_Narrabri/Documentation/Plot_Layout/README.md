...
## Current main file
- `2025USYD_Narrabri_plots.geojson` — fitted YYYY-MM-DD by <name>,
...
| --- | --- | --- | --- |
| `2025USYD_Narrabri_plots_YYYYMMDD_deprecated.geojson` | YYYY-MM-DD | <reason> | `2025USYD_Narrabri_plots.geojson` |
