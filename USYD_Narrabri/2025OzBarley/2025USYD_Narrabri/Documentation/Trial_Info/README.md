...
- `2025USYD_Narrabri_trial_info.csv` — source: <spreadsheet / contact>,
...
| --- | --- | --- | --- |
| `2025USYD_Narrabri_trial_info_YYYYMMDD_deprecated.csv` | YYYY-MM-DD | <reason> | `2025USYD_Narrabri_trial_info.csv` |
