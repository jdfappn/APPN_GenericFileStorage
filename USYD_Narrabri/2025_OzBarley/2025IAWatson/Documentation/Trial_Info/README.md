...
- `2025IAWatson_trial_info.csv` — source: <spreadsheet / contact>,
...
| --- | --- | --- | --- |
| `2025IAWatson_trial_info_YYYYMMDD_deprecated.csv` | YYYY-MM-DD | <reason> | `2025IAWatson_trial_info.csv` |
