...
## Current main file
- `2025York_F_plots.geojson` — fitted YYYY-MM-DD by <name>,
...
| --- | --- | --- | --- |
| `2025York_F_plots_YYYYMMDD_deprecated.geojson` | YYYY-MM-DD | <reason> | `2025York_F_plots.geojson` |
