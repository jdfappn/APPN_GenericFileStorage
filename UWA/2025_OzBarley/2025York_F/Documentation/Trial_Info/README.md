...
- `2025York_F_trial_info.csv` — source: <spreadsheet / contact>,
...
| --- | --- | --- | --- |
| `2025York_F_trial_info_YYYYMMDD_deprecated.csv` | YYYY-MM-DD | <reason> | `2025York_F_trial_info.csv` |
