...
## Current main file
- `2025Gatton_plots.geojson` — fitted YYYY-MM-DD by <name>,
...
| --- | --- | --- | --- |
| `2025Gatton_plots_YYYYMMDD_deprecated.geojson` | YYYY-MM-DD | <reason> | `2025Gatton_plots.geojson` |
