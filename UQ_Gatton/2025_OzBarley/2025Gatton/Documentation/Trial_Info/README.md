...
- `2025Gatton_trial_info.csv` — source: <spreadsheet / contact>,
...
| --- | --- | --- | --- |
| `2025Gatton_trial_info_YYYYMMDD_deprecated.csv` | YYYY-MM-DD | <reason> | `2025Gatton_trial_info.csv` |
